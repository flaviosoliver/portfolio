const projects = [
  {
    module: 'Mód. I - Fundamentos do Desenvolvimento Web',
    block: 'Bloco 03 - Introdução à HTML e CSS',
    name: 'Projeto Lessons Learned',
    alias: 'project-lessons-learned',
    stack: ['HTML', 'CSS'],
    description: 'Criar um site que com uma série de informações a respeito do que foi aprendido nos três blocos iniciais do curso na Trybe, estilizado de forma apropriada.',
    image: '../images/ProjectLessonsLearned.png',
  ...
  },
  {
    ...
    name: 'Projeto 05 - Arte com Pixels',
    alias: 'project-pixels-art',
    stack: ['JavaScript', 'DOM'],
    description: 'Implementar um editor de arte com pixels. Ou seja, dada uma paleta de cores e um quadro composto por pixels, permitir que quem usa consiga pintar o que quiser no quadro!',
    image: '../images/ProjectPixelsArt.png',
  ...
  },
  {
    module: 'Mód. I - Fundamentos do Desenvolvimento Web',
    block: 'Bloco 05 - JavaScript: DOM, Eventos e Web Storage',
    name: 'Projeto 06 - Meme Generator',
    alias: 'project-meme-generator',
    stack: ['JavaScript', 'DOM'],
    description: 'Criar uma página com Gerador de Meme, fazer upload de uma imagem para a página e adicione algum texto sobre ela.',
    image: '../images/ProjectMemeGenerator.png',
  ...
  },
  {
    module: 'Mód. I - Fundamentos do Desenvolvimento Web',
    block: 'Bloco 05 - JavaScript: DOM, Eventos e Web Storage',
    name: 'Projeto 07 - Lista de tarefas',
    alias: 'project-todo-list',
    stack: ['JavaScript', 'DOM'],
    description: 'Construir uma página para controle de Lista de Tarefas, integrando conhecimentos de HTML , CSS e JavaScript.',
    image: '../images/ProjectTodoList.png',
  ...
  },
  {
    ...
    name: 'Projeto 08 - Página inicial do Facebook',
    alias: 'project-facebook-signup',
    stack: ['JavaScript', 'CSS', 'HTML'],
    description: 'Recriar o icônico layout da tela de cadastro da rede social mais acessada do mundo, o Facebook, com uma audiência de mais de 2,3 bilhões de usuários por mês.',
    image: '../images/ProjectFacebookSignup.png',
  ...
  },
  {
    ...
    name: 'Projeto 09 - JavaScript Testes Unitários',
    alias: 'project-js-unit-tests',
    stack: ['NodeJS', 'Unit Test', 'JavaScript'],
    description: 'Implementar funções a partir de requisitos e testes unitários, utilizando o módulo Assert do NodeJS para verificar o correto funcionamento dessas funções.',
    image: '../images/ProjectJsUnitTests.png',
  ...
  },
  {
    ...
    name: 'Projeto 10 - Zoo Functions',
    alias: 'project-zoo-functions',
    stack: ['JavaScript', 'Higher Order Functions'],
    description: 'Simular um sistema de relatório de um zoológico. Você desenvolverá um conjunto de funções capazes de recuperar vários tipos de informações acerca do zoológico e de seu funcionamento. O sistema possui informações a respeito dos animais presentes no zoológico, colaboradores, horários de funcionamento e uma tabela de preços que varia de acordo com a idade das pessoas que o visitam.',
    image: '../images/ProjectZooFunctions.png',
  ...
  },
  {
    ...
    name: 'Projeto 11 - Carrinho de Compras',
    alias: 'project-shopping-cart',
    stack: ['Async', 'Promises'],
    description: 'Desenvolver um carrinho de compras. Este projeto visa colocar em prática todo o conteúdo aprendido sobre Web Storage e assincronicidade em JavaScript .',
    image: '../images/ProjectShoppingCart.png',
  ...
  },
  {
    ...
    name: 'Projeto 12 - Jest Assíncrono e Mocking',
    alias: 'project-jest',
    stack: ['Jest', 'Tests', 'Mock'],
    description: 'Implementar testes utilizando o Jest para verificar o correto funcionamento de uma série de funções.',
    image: '../images/ProjectJest.png',
    repo: 'https://github.com/flaviosoliver/project-jest',
    deploy: '',
  },
  {
    module: 'Mód. II - Desenvolvimento Front-end',
    block: 'Bloco 11 - Introdução à React',
    name: 'Projeto 13 - Movie Cards Library',
    alias: 'project-movie-cards-library',
    stack: ['React'],
    description: 'Desenvolver site usando React, onde este será uma biblioteca de cartões contendo informações sobre filmes.',
    image: '../images/ProjectMovieCardsLibrary.png',
  ...
  },
  {
    ...
    name: 'Projeto 14 - Movie Cards Library Stateful',
    alias: 'project-movie-card-library-stateful',
    stack: ['React'],
    description: 'Neste projeto também vai desenvolver uma biblioteca de filmes, tornando-a dinâmica via interação do usuário! Deve-se gerenciar estado e integrá-lo com capturas de eventos e formulários.',
    image: '',
    repo: 'https://github.com/flaviosoliver/project-movie-card-library-stateful',
    deploy: 'https://flaviosoliver.github.io/project-movie-card-library-stateful/',
  },
  {
    module: 'Mód. II - Desenvolvimento Front-end',
    block: 'Bloco 13 - Ciclo de Vida de Componentes e React Router',
    name: 'Projeto 15 - Movie Cards Library CRUD',
    alias: 'project-movie-card-library-crud',
    stack: ['React', 'CRUD', 'React Router', 'lifecycle-methods'],
    description: 'Agora a biblioteca terá diversas rotas, cada uma responsável por uma parte da funcionalidade. Desenvolver um app que permite criar, atualizar, visualizar e apagar cartões, colocando em prática os conceitos de React Router e lifecycle-methods',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 16 - Frontend Online Store',
    alias: 'project-frontend-online-store',
    stack: ['Kanban', 'React'],
    description: 'Construir o Front-End de um e-commerce, uma loja online, alimentada por uma API do Mercado Livre. Projeto em grupo! O objetivo é sedimentar tudo o que foi aprendido sobre React até aqui, enquanto praticam a organização de um projeto em time com a metodologia ágil e Kanban.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 17 - Testes em React',
  ...
  },
  {
    ...
    name: 'Projeto 18 - Trybe Wallet',
    stack: ['Redux', 'React'],
    alias: 'project-trybewallet',
    description: 'Criar uma aplicação que computa gastos em diferentes moedas e converte tudo para uma única moeda, que pode ser escolhida por quem usa. Utilizando Redux para gerenciamento de estado do React.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 19 - Jogo de Trivia',
    stack: ['Kanban', 'React', 'Redux'],
    alias: 'project-trivia-react-redux',
    description: 'Desenvolver um jogo de perguntas e respostas baseado no jogo Trivia, parecido um show do milhão americano, utilizando React e Redux. Projeto em Grupo.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 20 - StarWars DataTable com Context API e Hooks',
    stack: ['Context API', 'Hooks', 'React'],
    alias: 'project-starwars-datatable-hooks',
    description: 'Desenvolver uma tabela por meio de uma Requisição API, com dados de Planetas dos filmes StarWars, utilizando Context API e Hooks para controle de filtros.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 21 - App de Receitas',
    stack: ['Redux', 'Context API', 'Hooks', 'Kanban', 'Figma'],
    alias: 'project-recipes-app',
    description: 'Desenvolver um sistema que permite visualizar, buscar, filtrar, favoritar, compartilhar e acompanhar o processo de preparação de receitas e drinks. A base de dados serão 2 APIs distintas, uma para comidas e outra para bebidas. Utilizando conceitos de Redux, Context API e React Hooks. Projeto em grupo.',
    image: '',
    repo: 'https://github.com/flaviosoliver/project-recipes-app',
    deploy: '',
  },
  {
    module: 'Mód. III - Desenvolvimento Back-end',
    block: 'Bloco 20 - Introdução à SQL',
    name: 'Projeto 22 - All For One',
    stack: ['SQL', 'Banco de Dados', 'MySQL'],
    alias: 'project-mysql-all-for-one',
    description: 'Projeto com três níveis de desafios. Cada nível trabalhará habilidades diferentes: Desafios de SELECT e criação de dados; Desafios sobre filtragem de dados; Desafios de manipulação de tabelas. Com modelagem de dados N:1.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 23 - Vocabulary Booster',
    stack: ['SQL', 'MySQL', 'Banco de Dados'],
    alias: 'project-mysql-vocabulary-booster',
    description: 'Projeto com os seguintes desafios, em que trabalhará habilidades diferentes: Controle de fluxo com condicionais; Operações matemáticas; Lidando com datas; Manipulação de strings; Agrupamento de dados; Filtragem de dados; JOINS & UNIONS; Subqueries; Stored routines.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 25 - Data Flights',
    stack: ['NoSQL', 'MongoDB', 'Banco de Dados'],
    alias: 'project-mongodb-dataflights',
    description: 'Esse projeto está dividido em três níveis. Cada um deles trabalhará habilidades diferentes. Esses níveis são: Selecionar e contar documentos utilizando filtros simples; Selecionar e contar documentos utilizando filtros avançados e alguns operadores de comparação; Construir queries mais complexas juntando operadores de comparação e operadores lógicos.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 28 - Aggregations',
    stack: ['MongoDB', 'NoSQL', 'Aggregations', 'Banco de Dados'],
    alias: 'project-mongodb-aggregations',
    description: 'Esse projeto está dividido em três datasets. Cada um deles trabalhará habilidades diferentes. Esses datasets são: Uma base de dados com filmes, onde faremos várias operações para encontrar dados bem interessantes, além de transformá-los para uma melhor visualização; Uma base de dados com dados de rotas e parcerias de empresas aéreas; Por fim, uma base de dados com registros de utilização de bicicletas na cidade de Nova York.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 29 - Crush Manager',
    stack: ['NodeJS', 'API', 'CRUD'],
    alias: 'project-crush-manager',
    description: 'Construir uma API de cadastro de crushs, onde será possível cadastrar, visualizar, pesquisar, editar e excluir crushs.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 30 - Store Manager',
    stack: ['NodeJS', 'MongoDB', 'MSC', 'API Restful', 'CRUD', 'Banco de Dados'],
    alias: 'project-store-manager',
    description: 'Arquitetar e desenvolver uma API com banco de dados MongoDB. Desenvolver endpoints para criar, exibir, atualizar e excluir produtos e vendas. Utilizar padrões arquiteturais MSC (model-service-controller). Além disso, exercitar conhecimentos sobre REST, criando uma API completamente RESTful.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 33 - Trybeer',
    alias: 'project-trybeer',
    stack: ['Kanban', 'CRUD', 'API Rest', 'MySQL', 'Banco de Dados'],
    description: 'Criar uma plataforma de delivery de cerveja. Para facilitar o entendimento, dá para dividirmos a aplicação em três partes: API (compartilhada entre cliente e admin); Front-end cliente (onde o cliente vai comprar a cerveja); Front-end admin (onde o estabelecimento controla os pedido feitos). Projeto em Grupo!',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 34 - API de Blogs',
    alias: 'project-blogs-api',
    stack: ['SOLID', 'ORM', 'CRUD', 'Sequelize', 'MySQL', 'Banco de Dados'],
    description: 'Desenvolver e testar uma API para um Blog, além de um banco de dados. Usando como exemplo a API do Blogger. Nela, terá um CRUD de postagens com uma camada de autenticação de pessoas usuárias.',
    image: '',
  ...
  },
  {
    ...
    name: 'Projeto 37 - Inventory Reports',
    stack: ['Python', 'POO'],
