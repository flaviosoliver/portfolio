...
class CarouselImg extends Component {
  ...
  <Carousel.Item>
    ...
    />
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Lessons Learned</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Playground Functions</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Pixels Art</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Meme Generator</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Todo List</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Facebook Sign-up</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - JavaScript Unit Tests</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Zoo Functions</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Shopping Cart</h3>
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption className="img-slide">
      <h3>Fundamentos do Desenvolvimento Web - Jest</h3>
